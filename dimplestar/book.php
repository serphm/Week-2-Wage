...
<form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" style="text-align:center;">
	<table height="50%" width="30%" border="0" style="margin: 0 auto; text-align:left;">
		<tr>
		...
		<tr>
			<td colspan="4" style="text-align:center;">
				<input type="radio" name="way" value="2" onclick="document.getElementById('datepick2').disabled=false"> Two Way
				<input type="radio" name="way" value="1" onclick="document.getElementById('datepick2').disabled=true" checked> One Way
			</td>
		</tr> 
		<tr>
		...
		<tr>
			...
			<td colspan="2"><input type="number" name="no_of_pass" required /></td>
		</tr>
		<tr>
			<td colspan="2">Departure</td>
			<td colspan="2"><input id="datepick1" size="10" name="Departure" /></td>
		</tr>
		<tr>
			<td colspan="2">Return</td>
			<td colspan="2"><input id="datepick2" size="10" name="Return" disabled /></td>
		</tr>
		<tr>
		...
		<tr>
			<td colspan="4" style="text-align:center; padding-top:10pt;">
